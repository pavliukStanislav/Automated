...
namespace Automated.API.Tests.Steps.Examples.Selenium
{
    [Binding]
    public sealed class ExampleSpecflowSteps
    {
        ...
        public void GivenSimpleStepDefinition()
        {
        ...
        [Given(@"Async step definition")]
        public async Task GivenAsyncStepDefinition()
        {
            await GetTask();
        }
        ...
        public void GivenCreateInstanceFromTableStep(Table table)
        {
        ...
        [When(@"Compare instance step")]
        public void WhenCompareInstanceStep(Table table)
        {
